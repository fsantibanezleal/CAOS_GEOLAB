...
const en = {
  ...
  'wb.intro':
    'Generate a synthetic sample DEM and run a real WhiteboxTools tool — Slope — entirely client-side via the geolibre WASM engine. No upload, no server, your data never leaves the page. (Bring-your-own-GeoTIFF and the full map / toolbox / pipeline workbench land next.)',
...
const es: typeof en = {
  ...
  'wb.intro':
    'Genera un DEM de muestra sintético y corre una herramienta real de WhiteboxTools — Pendiente (Slope) — completamente del lado del cliente con el motor WASM geolibre. Sin subir nada, sin servidor, tus datos nunca salen de la página. (Cargar-tu-propio-GeoTIFF y el workbench completo mapa / herramientas / pipeline vienen a continuación.)',
