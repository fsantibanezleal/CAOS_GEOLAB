...
export const ENGINE_CATALOG: EngineInfo[] = [
  { engine: 'geolibre', project: 'WhiteboxTools / geolibre-rust', authors: 'J. Lindsay; opengeos (Q. Wu)', license: 'MIT', tier: 'permissive', url: 'https://github.com/opengeos/geolibre-rust', approxTools: 740, status: 'adapter-scaffold' },
  { engine: 'turf', project: 'Turf.js', authors: 'Turf.js contributors', license: 'MIT', tier: 'permissive', url: 'https://turfjs.org/', approxTools: 150, status: 'planned' },
